...
par(mfrow=c(2,2))
hist(h_tls_top_res, main = "TLS Mean Canopy Height", col = '#568fda', ylim = c(0,70), xlim = c(0,35), breaks = 20)
hist(h_s2_top, main = "Sentinel Mean Canopy Height", col = '#568fda', ylim = c(0,70), xlim = c(0,35), breaks = 1)
hist(h_tls_sd_res, main = "TLS SD of Canopy Height", col = "#038203", ylim = c(0,120),  xlim = c(0,12), breaks =20)
hist(h_s2_sd, main = " Sentinel SD of Canopy Height", col = '#038203', ylim = c(0,120),  xlim = c(0,12), breaks = 3)
